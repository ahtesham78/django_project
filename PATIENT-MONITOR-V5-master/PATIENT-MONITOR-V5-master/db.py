...
if __name__ == "__main__":
    ...
    # mydb. insert_setting("Hr","120")
    # mydb. insert_setting("RR","18")
    # mydb. insert_setting("Tem","93")
    # mydb. insert_setting("PR","118 ")
    # mydb. insert_setting("SPO2","99")
    # mydb. insert_setting("SYS","99 ")
    # mydb. insert_setting("Pluse","103 ")
